...
from cluster_utils import RAPTOR_Clustering, RAPTOR_DBSCAN_Clustering
from utils import (
    get_embeddings,
...
def main():
    ...
    parser.add_argument("--num-papers", type=int, default=1, help="Number of QASPER papers to evaluate")
    ...
    parser.add_argument(
        ...
        default="som",
        choices=["som", "dbscan"],
        help="Clustering backend to use for RAPTOR tree (SOM or DBSCAN)",
    )
    parser.add_argument(
        "--output-file",
        type=str,
